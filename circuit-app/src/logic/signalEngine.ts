...
function preferredThemes(jsDay: number, kind: SignalKind): readonly string[] {
  ...
  if (kind === "morning") {
    ...
    const map: Record<number, readonly string[]> = {
      0: [...core, "presence"],
      1: [...core, "anticipation"],
      2: [...core, "calendar_stress"],
      3: [...core, "overload"],
      4: [...core, "time_travel"],
      5: [...core, "mode_shift"],
      6: [...core, "passive_drift"],
    };
  ...
  const map: Record<number, readonly string[]> = {
    0: [...lateCore, "time_travel"],
    1: [...lateCore, "rumination"],
    2: [...lateCore, "cognitive_dead_end"],
    3: [...lateCore, "physical_grounding"],
    4: [...lateCore, "reality_anchor"],
    5: [...lateCore, "mode_shift"],
    6: [...lateCore, "presence"],
  };
  return map[jsDay] ?? map[1]!;
}
...
function scoreLine(
  ...
  if (line.theme === "closure" && (kind === "lateNight" || kind === "evening")) {
    s += 1.5;
  }
  if (
  ...
  if (line.theme === "screen_break" && kind === "lateNight") {
    s += 1.5;
  }
